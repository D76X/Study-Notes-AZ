...
In other words, any time an organization wishes to send information resident on-premise to their cloud infrastructure and/or receive information from their cloud infrastructure into their on-premise network this can be achieved **securely** by employed Relay Services.

#### Business Scenario for Relay Services

The business manages a set of files i.e. HR documentation, catalogs or similar and wish to be able to propagate any changes made to these assets through their cloud infrastructure so that they may eventually reach their end users i.e. their employees.   
