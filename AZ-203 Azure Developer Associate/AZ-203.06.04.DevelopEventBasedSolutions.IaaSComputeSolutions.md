...
2. Select the pricing tier BASIC or STANDARD.
3. Create one or more Event Hubs inside the Namespace.
4. Enable the **auto-inflate feature** if you need it.
