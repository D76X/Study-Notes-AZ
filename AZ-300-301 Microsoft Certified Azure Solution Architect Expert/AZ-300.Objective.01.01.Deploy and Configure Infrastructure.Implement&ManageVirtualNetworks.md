...
- **VNet** are **the fundamental building block of IaaS in Azure**.
- **VNets** have **front end access** via the following Azure appliances.
...
### Traffic Manager Routing strategies

The **Traffic Manager** is an **Azure Appliance** used to route traffic between EPs.
